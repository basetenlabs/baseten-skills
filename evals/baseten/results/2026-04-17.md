...
Archived pilot, including the April 20 rerun noted below. Observations and proposed changes describe that experiment, not the current skill or an open work queue. See the [evaluation guide](../README.md) for current results.
...
The five prompts above are the evaluated set. The suite in `skills/baseten/evals/evals.json` has since changed.
...
At the time of this report, these candidate changes had not been applied.
